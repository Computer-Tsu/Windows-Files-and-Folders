...
- **Owner:** `camsvc` (Capability Access Manager service) — tracks app permission requests for camera, microphone, location, and screen capture, storing every access request in a SQLite database [IT-Connect -<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewbox="0 0 256 256" class="transition-all group-hover/tag:ease-out duration-\[500ms\] ease-in text-accent-100 group-hover/tag:scale-\[100%\] scale-\[80%\] group-hover/tag:opacity-\[100%\] opacity-\[0%\] -mr-\[2px\]"><path d="M200,64V168a8,8,0,0,1-16,0V83.31L69.66,197.66a8,8,0,0,1-11.32-11.32L172.69,72H88a8,8,0,0,1,0-16H192A8,8,0,0,1,200,64Z"></path></svg>](https://www.it-connect.tech/windows-11-this-hidden-file-can-devour-your-entire-disk/)
- **Normal size:** under 4 MB for the whole folder on an unaffected PC, with the .db-wal file around 1.6 MB [IT-Connect -<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewbox="0 0 256 256" class="transition-all group-hover/tag:ease-out duration-\[500ms\] ease-in text-accent-100 group-hover/tag:scale-\[100%\] scale-\[80%\] group-hover/tag:opacity-\[100%\] opacity-\[0%\] -mr-\[2px\]"><path d="M200,64V168a8,8,0,0,1-16,0V83.31L69.66,197.66a8,8,0,0,1-11.32-11.32L172.69,72H88a8,8,0,0,1,0-16H192A8,8,0,0,1,200,64Z"></path></svg>](https://www.it-connect.tech/windows-11-this-hidden-file-can-devour-your-entire-disk/)
- **Bug:** Windows 11 24H2 and 25H2 have a known bug where camsvc enters a continuous loop and repeatedly writes entries to the log file, with the WAL never merging back into the main database and ballooning past 500 GB in some cases. Community root-cause tracing (Process Monitor) pointed to repeated Location-permission requests triggering the loop. [WinTips.org<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewbox="0 0 256 256" class="transition-all group-hover/tag:ease-out duration-\[500ms\] ease-in text-accent-100 group-hover/tag:scale-\[100%\] scale-\[80%\] group-hover/tag:opacity-\[100%\] opacity-\[0%\] -mr-\[2px\]"><path d="M200,64V168a8,8,0,0,1-16,0V83.31L69.66,197.66a8,8,0,0,1-11.32-11.32L172.69,72H88a8,8,0,0,1,0-16H192A8,8,0,0,1,200,64Z"></path></svg>](https://www.wintips.org/how-to-fix-capabilityaccessmanager-db-wal-taking-up-huge-disk-space-on-windows-11/)[IT-Connect -<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewbox="0 0 256 256" class="transition-all group-hover/tag:ease-out duration-\[500ms\] ease-in text-accent-100 group-hover/tag:scale-\[100%\] scale-\[80%\] group-hover/tag:opacity-\[100%\] opacity-\[0%\] -mr-\[2px\]"><path d="M200,64V168a8,8,0,0,1-16,0V83.31L69.66,197.66a8,8,0,0,1-11.32-11.32L172.69,72H88a8,8,0,0,1,0-16H192A8,8,0,0,1,200,64Z"></path></svg>](https://www.it-connect.tech/windows-11-this-hidden-file-can-devour-your-entire-disk/)
...
- **Cause:** Not a formally documented Microsoft bug — persistent community-reported issue where the DB grows to hundreds of MB and the service re-uploads/reloads it on every logon, also spiking RAM. One user found the file at 800 MB and suspected the service was loading it entirely into memory to upload contents to Microsoft servers. [Microsoft Learn<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewbox="0 0 256 256" class="transition-all group-hover/tag:ease-out duration-\[500ms\] ease-in text-accent-100 group-hover/tag:scale-\[100%\] scale-\[80%\] group-hover/tag:opacity-\[100%\] opacity-\[0%\] -mr-\[2px\]"><path d="M200,64V168a8,8,0,0,1-16,0V83.31L69.66,197.66a8,8,0,0,1-11.32-11.32L172.69,72H88a8,8,0,0,1,0-16H192A8,8,0,0,1,200,64Z"></path></svg>](https://learn.microsoft.com/en-us/answers/questions/4336026/connected-devices-platform-user-service-uploads-da)
...
- **Cause:** Windows.edb becomes larger than expected when a PST file is indexed — the size grows in proportion to the size of the PST file, and this issue doesn't occur in Windows 7. Windows 8/8.1/10 store both properties and persistent indexes in Windows.edb and index entire file contents regardless of size, neither of which is configurable. [microsoft<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewbox="0 0 256 256" class="transition-all group-hover/tag:ease-out duration-\[500ms\] ease-in text-accent-100 group-hover/tag:scale-\[100%\] scale-\[80%\] group-hover/tag:opacity-\[100%\] opacity-\[0%\] -mr-\[2px\]"><path d="M200,64V168a8,8,0,0,1-16,0V83.31L69.66,197.66a8,8,0,0,1-11.32-11.32L172.69,72H88a8,8,0,0,1,0-16H192A8,8,0,0,1,200,64Z"></path></svg>](https://learn.microsoft.com/en-us/troubleshoot/windows-client/shell-experience/larger-windowsdotedb-file)[microsoft<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewbox="0 0 256 256" class="transition-all group-hover/tag:ease-out duration-\[500ms\] ease-in text-accent-100 group-hover/tag:scale-\[100%\] scale-\[80%\] group-hover/tag:opacity-\[100%\] opacity-\[0%\] -mr-\[2px\]"><path d="M200,64V168a8,8,0,0,1-16,0V83.31L69.66,197.66a8,8,0,0,1-11.32-11.32L172.69,72H88a8,8,0,0,1,0-16H192A8,8,0,0,1,200,64Z"></path></svg>](https://learn.microsoft.com/en-us/troubleshoot/windows-client/shell-experience/larger-windowsdotedb-file)
- **KB:** **KB2952967** — Win 10/8.1/8, the PST-indexing bloat issue. **KB2836988** — older May 2013 rollup for the constant growth of Windows.edb on Windows 8 and Windows Server 2012. [Helpspot<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewbox="0 0 256 256" class="transition-all group-hover/tag:ease-out duration-\[500ms\] ease-in text-accent-100 group-hover/tag:scale-\[100%\] scale-\[80%\] group-hover/tag:opacity-\[100%\] opacity-\[0%\] -mr-\[2px\]"><path d="M200,64V168a8,8,0,0,1-16,0V83.31L69.66,197.66a8,8,0,0,1-11.32-11.32L172.69,72H88a8,8,0,0,1,0-16H192A8,8,0,0,1,200,64Z"></path></svg>](https://techpros.helpspot.com/index.php?pg=kb.page&amp;id=35)
...
- **Owner:** Windows Modules Installer / TrustedInstaller (Component-Based Servicing) — records detailed information about servicing operations, changes to system files, and Windows Update/SFC operations [MiniTool<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewbox="0 0 256 256" class="transition-all group-hover/tag:ease-out duration-\[500ms\] ease-in text-accent-100 group-hover/tag:scale-\[100%\] scale-\[80%\] group-hover/tag:opacity-\[100%\] opacity-\[0%\] -mr-\[2px\]"><path d="M200,64V168a8,8,0,0,1-16,0V83.31L69.66,197.66a8,8,0,0,1-11.32-11.32L172.69,72H88a8,8,0,0,1,0-16H192A8,8,0,0,1,200,64Z"></path></svg>](https://www.minitool.com/partition-disk/cbslog-file-growing-so-large.html)
- **Cause:** Log files are split at 50 MB and compressed via makecab, but if a file grows to 2 GB before compression, makecab can't compress it and the file balloons rapidly — typically triggered by a stuck/repeatedly-failing update. [Appuals<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewbox="0 0 256 256" class="transition-all group-hover/tag:ease-out duration-\[500ms\] ease-in text-accent-100 group-hover/tag:scale-\[100%\] scale-\[80%\] group-hover/tag:opacity-\[100%\] opacity-\[0%\] -mr-\[2px\]"><path d="M200,64V168a8,8,0,0,1-16,0V83.31L69.66,197.66a8,8,0,0,1-11.32-11.32L172.69,72H88a8,8,0,0,1,0-16H192A8,8,0,0,1,200,64Z"></path></svg>](https://appuals.com/component-based-servicing-cbs-log-using-excessive-disk-space/)
...
- **Documented bug:** on x64 Windows 8.1, Server 2012 R2, Windows 8, or Server 2012, if a registry hive exceeds the 2 GB size limit, the computer can't be restarted — symptoms include boot to stop error, or booting into a temp profile blocked by Registry Quota Limit. [microsoft<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewbox="0 0 256 256" class="transition-all group-hover/tag:ease-out duration-\[500ms\] ease-in text-accent-100 group-hover/tag:scale-\[100%\] scale-\[80%\] group-hover/tag:opacity-\[100%\] opacity-\[0%\] -mr-\[2px\]"><path d="M200,64V168a8,8,0,0,1-16,0V83.31L69.66,197.66a8,8,0,0,1-11.32-11.32L172.69,72H88a8,8,0,0,1,0-16H192A8,8,0,0,1,200,64Z"></path></svg>](https://learn.microsoft.com/en-us/archive/blogs/supportingwindows/unable-to-restart-server-due-to-registry-bloat-over-2gb)[microsoft<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewbox="0 0 256 256" class="transition-all group-hover/tag:ease-out duration-\[500ms\] ease-in text-accent-100 group-hover/tag:scale-\[100%\] scale-\[80%\] group-hover/tag:opacity-\[100%\] opacity-\[0%\] -mr-\[2px\]"><path d="M200,64V168a8,8,0,0,1-16,0V83.31L69.66,197.66a8,8,0,0,1-11.32-11.32L172.69,72H88a8,8,0,0,1,0-16H192A8,8,0,0,1,200,64Z"></path></svg>](https://learn.microsoft.com/en-us/archive/blogs/supportingwindows/unable-to-restart-server-due-to-registry-bloat-over-2gb)
- **KB:** **KB2978366**
...
- **Owner:** Outlook Cached Exchange Mode local cache
- **Cause:** Outlook .OST files can exceed the 50 GB limit when using Cached Exchange Mode, since all folders and items from shared mailboxes get cached locally too, especially with shared-mailbox automapping enabled. Large amounts of Public Folder Favorites or shared mailbox access under CEM can add up quickly. [WinTips.org<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewbox="0 0 256 256" class="transition-all group-hover/tag:ease-out duration-\[500ms\] ease-in text-accent-100 group-hover/tag:scale-\[100%\] scale-\[80%\] group-hover/tag:opacity-\[100%\] opacity-\[0%\] -mr-\[2px\]"><path d="M200,64V168a8,8,0,0,1-16,0V83.31L69.66,197.66a8,8,0,0,1-11.32-11.32L172.69,72H88a8,8,0,0,1,0-16H192A8,8,0,0,1,200,64Z"></path></svg>](https://www.wintips.org/fix-outlook-ost-data-file-exceeds-50-gb-limit-with-shared-mailboxes/)[Microsoft Learn<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewbox="0 0 256 256" class="transition-all group-hover/tag:ease-out duration-\[500ms\] ease-in text-accent-100 group-hover/tag:scale-\[100%\] scale-\[80%\] group-hover/tag:opacity-\[100%\] opacity-\[0%\] -mr-\[2px\]"><path d="M200,64V168a8,8,0,0,1-16,0V83.31L69.66,197.66a8,8,0,0,1-11.32-11.32L172.69,72H88a8,8,0,0,1,0-16H192A8,8,0,0,1,200,64Z"></path></svg>](https://learn.microsoft.com/en-us/archive/msdn-technet-forums/7cf673b7-5d86-47a6-a439-ca0d2adc73d7)
- **Limit:** Outlook 2010+ supports OST files up to 20 GB in Unicode format; the older ANSI format was capped at 2 GB (registry `MaxLargeFileSize`/`WarnLargeFileSize` DWORDs under `HKCU\...\Outlook\PST` raise this). [Practical 365<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewbox="0 0 256 256" class="transition-all group-hover/tag:ease-out duration-\[500ms\] ease-in text-accent-100 group-hover/tag:scale-\[100%\] scale-\[80%\] group-hover/tag:opacity-\[100%\] opacity-\[0%\] -mr-\[2px\]"><path d="M200,64V168a8,8,0,0,1-16,0V83.31L69.66,197.66a8,8,0,0,1-11.32-11.32L172.69,72H88a8,8,0,0,1,0-16H192A8,8,0,0,1,200,64Z"></path></svg>](https://practical365.com/outlook-cached-mode-ost-file-sizes/)
...
| Path | Owner | Notes |
| --- | --- | --- |
| `C:\Windows\SoftwareDistribution\Download` | wuauserv | Orphaned update payloads; `net stop wuauserv`, clear, restart |
| `C:\Windows\SoftwareDistribution\DeliveryOptimization` | DoSvc | P2P update cache, grows if LAN/Internet peering enabled |
| `C:\ProgramData\Microsoft\Windows\WER\ReportQueue` / `ReportArchive` | WerSvc | Crash dump accumulation from crash-looping apps |
| `C:\Windows\System32\spool\PRINTERS` | Spooler | Stuck jobs leave orphaned .SPL/.SHD files |
| `C:\Windows.old` | Setup | Feature-upgrade rollback data, auto-purged after 10 days |
| `$Windows.~BT`, `$Windows.~WS` (drive root, hidden) | Setup | Leftover from failed/incomplete feature upgrades, 20+ GB possible |
...
For Win 3.x, you copy+concatenated the launcher to a RLE (run length encoded) picture
...
`sc` services<br>
`C:\Windows\System32\SCRegEdit.wsh` enable or disable Remote Desktop and configure Windows Update<br>
...
`net.exe` add/remove users, connect to network drives<br>
`pnputil` drivers<br>
`drvinst` drivers<br>
`diskraid` RAID volumes<br>
`ServerManagerCmd.exe`<br>
`MSInfo32.exe`<br>
`Regedit.exe` and `Regedt32.exe`<br>
`secedit.exe`<br>
`TimeDate.cpl`<br>
`timezone.cpl` change the time and time zone<br>
`Intl.cpl`<br>
`iscsicpl.exe` connect to shared storage over iSCSI (starting with Windows Server 2008 R2)<br>
...
#### from System Configuration (msconfig), Tools, Launch
...
### Additional Microsoft Software for Administrators
...
Orca - create .MST transform files to apply choices to unattended .msi installs
...
### Windows Domain and Active Directory paths
...
#### DNS entries for Active Directory Domains
...
#### Edit Objects in Active Directory
